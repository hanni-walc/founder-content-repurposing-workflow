  ...
  return (
    <main className="shell">
      <section className="frame hero">
        ...
        <h1>Enter the repurposing workflow.</h1>
        <p className="lead">Manage sources, projects, voices, and exports in one clean workspace.</p>
      </section>
      ...
      <section className="card">
        <div className="grid cols-2">
          <label className="card" style={{ padding: 16 }}>
            ...
            <input className="input" placeholder="founder@company.com" />
          </label>
          <label className="card" style={{ padding: 16 }}>
